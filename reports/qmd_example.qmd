...
![Horse populations for all provinces in Canada from 1906 - 1972.](../results/horse_pops_plot.png){#fig-horse_pops_plot width=70%}
...
We present the standard deviations in @tbl-my-data.
...
Additionally, note that in @tbl-my-data we consider the sample standard deviation of the number of horses during the same time span as @fig-horse_pops_plot.

![Horse populations for the province with the largest standard deviation](../results/horse_pops_plot_largest_sd.png){#fig-horse_pops_plot_largest_sd width=60%}
